...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiServiceProvider(
      providers: [
        ServiceProvider<RoutingService>(
        create: (context) => RoutingService(routes: routes)),
        ],
      child: MultiRepositoryProvider(
        ...
        child: RepositoryProvider<AuthRepository>(
          ...
          child: MultiBlocProvider(
            providers: [
              BlocProvider(
                create: (context) => AuthenticationBloc(authenticationRepository: context.read<AuthRepository>()),
              )
            ],
            child: const AppView(),
          ),
